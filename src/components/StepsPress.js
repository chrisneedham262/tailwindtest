/* Originally for the steps on the press page - currently using something else*/

const steps = [
  { id: "Contacts", href: "#", status: "complete" },
  { id: "New Contacts", href: "#", status: "current" },
];

export default function Steps() {
  return (
    <nav aria-label="Progress">
      <ol className="w-25 space-y-1 md:flex md:space-y-0 md:space-x-20">
        {steps.map((step) => (
