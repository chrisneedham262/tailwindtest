...
const callsToAction = [
  { name: "Watch Demo", href: "/about", icon: PlayIcon },
  { name: "View All Products", href: "/about", icon: CheckCircleIcon },
  { name: "Contact Sales", href: "/about", icon: PhoneIcon },
];
const company = [
  { name: "About", href: "/about", icon: InformationCircleIcon },
  { name: "Contact", href: "/contact", icon: OfficeBuildingIcon },
  { name: "Press", href: "/about", icon: NewspaperIcon },
  { name: "Careers", href: "/about", icon: BriefcaseIcon },
  { name: "Privacy", href: "/about", icon: ShieldCheckIcon },
];
const resources = [
  { name: "Community", href: "/about", icon: UserGroupIcon },
  { name: "Partners", href: "/about", icon: GlobeAltIcon },
  { name: "Guides", href: "/about", icon: BookmarkAltIcon },
  { name: "Webinars", href: "/about", icon: DesktopComputerIcon },
];
const blogPosts = [
  {
    id: 1,
