          ...
          <div className="pb-16 xl:flex xl:items-center xl:justify-between">
            <div>
              <h1 className="text-4xl font-extrabold sm:text-5xl sm:tracking-tight">
                ...
                <span className="text-indigo-600 line-through">
                  $49 a month
                </span>
              </h1>
              <p className="mt-5 text-xl text-gray-500">
                It's free! Including every feature we offer plus unlimited
                projects and unlimited users.
              </p>
            </div>
            <a
              href="/Signup"
              className="mt-8 w-full bg-indigo-600 hover:bg-indigo-700 border border-transparent rounded-md py-3 px-5 inline-flex items-center justify-center text-base font-medium text-white sm:mt-10 sm:w-auto xl:mt-0"
            >
              Get started today
            </a>
          </div>
