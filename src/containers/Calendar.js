...
//         <div>
//           <h4 className="text-xs xl:text-base text-gray-900 dark:text-gray-100">
//             September 2018
//           </h4>
//         </div>
...
//             <h4 className="text-indigo-700 cursor-pointer text-xs lg:text-base font-light text-right">
//               Month view
//             </h4>
//           </a>
//         </div>
//         <div>
//           <a href="javascript:void(0)">
//             <h4 className="text-xs lg:text-base cursor-pointer text-gray-700 dark:text-gray-200 font-light text-right ml-6">
//               Week view
//             </h4>
//           </a>
//         </div>
...
//             <tr className="h-20">
//               <th className="px-10">
//                 <p className="text-xs text-left text-gray-900 dark:text-gray-100 uppercase cursor-pointer">
//                   Monday
//                 </p>
//               </th>
//               <th className="px-10">
...
//                 <p className="text-xs text-gray-800 dark:text-gray-100 pt-2 pl-2 pb-16">
//                   27
//                 </p>
//               </td>
//               <td className="border-r border-gray-300 dark:border-gray-700">
...
//                       4 Sept – 5 Sept
//                     </p>
//                     <p className="text-xs text-gray-800 dark:text-gray-100 mt-0.5">
//                       Vacation
//                     </p>
//                   </div>
//                 </div>
