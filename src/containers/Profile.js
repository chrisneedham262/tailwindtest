...
const Profile = ({
  ...
  const onSubmit = (e) => {
    ...
    console.log("the fiorm data is=====", formData);
    ...
    <div className="h-screen flex overflow-hidden bg-gray-100">
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden">
        ...
        <form
          ...
          className="space-y-8 divide-y divide-gray-200 m-4 overflow-scroll"
        >
                ...
                <div className="sm:col-span-3 form-group">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      value={first_name}
                      className="form-control shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                    />
                  </div>
                </div>
